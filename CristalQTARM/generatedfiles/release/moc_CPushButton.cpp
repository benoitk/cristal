...
static const char qt_meta_stringdata_CPushButton[] = {
    "CPushButton\0\0id\0clicked(int)\0"
    "objectClicked()\0"
};
...
void CPushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->objectClicked(); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData CPushButton::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CPushButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_CPushButton,
      qt_meta_data_CPushButton, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CPushButton::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CPushButton))
...
// SIGNAL 0
void CPushButton::clicked(int _t1)
{
