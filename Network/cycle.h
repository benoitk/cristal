...
class NETWORK_API CElemCycleStep : public CElemBase
{
public:
	CElemCycleStep();
...
class NETWORK_API CElemCycle : public CElemList
{
public:
	CElemCycle();
	virtual ~CElemCycle();
...
*
*****************************************************************************************@!)*/
class NETWORK_API CElemCycleZero : public CElemCycle
{
public:
	CElemCycleZero();
...
*
*****************************************************************************************@!)*/
class NETWORK_API CElemCycleCalib : public CElemCycleZero
{
public:
	CElemCycleCalib();
...
*
*****************************************************************************************@!)*/
class NETWORK_API CElemCycleCleanup : public CElemCycle
{
public:
	CElemCycleCleanup();
