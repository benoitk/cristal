...
void ReadConfigMsgError(LPTSTR szFileMsg)
{
	...
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgRegulControlLuggageHeatingUnattained"),_T(""),_aszErrorText[eErrorPrgRegulControlLuggageHeatingUnattained],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgRegulControlHeatingTemperatureUnstable"),_T(""),_aszErrorText[eErrorPrgRegulControlHeatingTemperatureUnstable],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgWaterDefaultLackOfWater"),_T(""),_aszErrorText[eErrorPrgWaterDefaultLackOfWater],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgWaterDefaultDefaultMeasure"),_T(""),_aszErrorText[eErrorPrgWaterDefaultDefaultMeasure],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgDefaultOpticalSetting"),_T(""),_aszErrorText[eErrorPrgDefaultOpticalSetting],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgDefaultIncorrectOpticalSetting"),_T(""),_aszErrorText[eErrorPrgDefaultIncorrectOpticalSetting],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgDefaultCurrentProjector"),_T(""),_aszErrorText[eErrorPrgDefaultCurrentProjector],MAX_PATH,szFileMsg);
	
	
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgOpticalMeasureDefaultMeasure"),_T(""),_aszErrorText[eErrorPrgOpticalMeasureDefaultMeasure],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgOpticalMeasureDefaultStability"),_T(""),_aszErrorText[eErrorPrgOpticalMeasureDefaultStability],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgAbsorbanceCalculDivByZero"),_T(""),_aszErrorText[eErrorPrgAbsorbanceCalculDivByZero],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgConcentrationCalculDivByZero"),_T(""),_aszErrorText[eErrorPrgConcentrationCalculDivByZero],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgConcentrationCalculOutOfBound"),_T(""),_aszErrorText[eErrorPrgConcentrationCalculOutOfBound],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgCalibrationCoefCalculDivByZero"),_T(""),_aszErrorText[eErrorPrgCalibrationCoefCalculDivByZero],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgCalibrationCoefCalculOutOfBound"),_T(""),_aszErrorText[eErrorPrgCalibrationCoefCalculOutOfBound],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgLinearisationDivByZero"),_T(""),_aszErrorText[eErrorPrgLinearisationDivByZero],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgLinearisationOutOfRange"),_T(""),_aszErrorText[eErrorPrgLinearisationOutOfRange],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgInverseLinDivByZero"),_T(""),_aszErrorText[eErrorPrgInverseLinDivByZero],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgInverseLinOutOfRange"),_T(""),_aszErrorText[eErrorPrgInverseLinOutOfRange],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgConfigInitNegativeGain"),_T(""),_aszErrorText[eErrorPrgConfigInitNegativeGain],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgCalibrationCoefCalculM2DivByZero"),_T(""),_aszErrorText[eErrorPrgCalibrationCoefCalculM2DivByZero],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgCalibrationCoefCalculM2OutOfGap"),_T(""),_aszErrorText[eErrorPrgCalibrationCoefCalculM2OutOfGap],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgOffsetZeroCalculDivByZero"),_T(""),_aszErrorText[eErrorPrgOffsetZeroCalculDivByZero],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgOffsetZeroCalculOutOfBound"),_T(""),_aszErrorText[eErrorPrgOffsetZeroCalculOutOfBound],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgConfigInitNegativeProbeGain"),_T(""),_aszErrorText[eErrorPrgConfigInitNegativeProbeGain],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrgHeatWaterControlDefaultHeatWater"),_T(""),_aszErrorText[eErrorPrgHeatWaterControlDefaultHeatWater],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg203"),_T(""),_aszErrorText[eErrorPrg203],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg205"),_T(""),_aszErrorText[eErrorPrg205],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg213"),_T(""),_aszErrorText[eErrorPrg213],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg215"),_T(""),_aszErrorText[eErrorPrg215],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg219"),_T(""),_aszErrorText[eErrorPrg219],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg223"),_T(""),_aszErrorText[eErrorPrg223],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg225"),_T(""),_aszErrorText[eErrorPrg225],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg229"),_T(""),_aszErrorText[eErrorPrg229],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg22D"),_T(""),_aszErrorText[eErrorPrg22D],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg233"),_T(""),_aszErrorText[eErrorPrg233],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg235"),_T(""),_aszErrorText[eErrorPrg235],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg245"),_T(""),_aszErrorText[eErrorPrg245],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg243"),_T(""),_aszErrorText[eErrorPrg243],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg253"),_T(""),_aszErrorText[eErrorPrg253],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg255"),_T(""),_aszErrorText[eErrorPrg255],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg259"),_T(""),_aszErrorText[eErrorPrg259],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg443"),_T(""),_aszErrorText[eErrorPrg443],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg453"),_T(""),_aszErrorText[eErrorPrg453],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg463"),_T(""),_aszErrorText[eErrorPrg463],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg465"),_T(""),_aszErrorText[eErrorPrg465],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg173"),_T(""),_aszErrorText[eErrorPrg173],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg393"),_T(""),_aszErrorText[eErrorPrg393],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg403"),_T(""),_aszErrorText[eErrorPrg403],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg405"),_T(""),_aszErrorText[eErrorPrg405],MAX_PATH,szFileMsg);
	dwGetPrivateProfileString(_T("MSG"), _T("eErrorPrg413"),_T(""),_aszErrorText[eErrorPrg413],MAX_PATH,szFileMsg);
...
void TRACE_LOG_ERROR_PRG(CStream* argObjVoie, CElemInt8* argNumCurrentStream, int argiNumMesure, int argiNumPas)
{
	...
	{
		//!\A gérer dynamiquement en V3 avec un fichier de conf supplémentaire pour la mapping
		//PRG_000
		case 0:
			break;
		//PRG_ATTENTE
		...
		case 3:
			...
			verifierDefaut(0x05, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgRegulControlLuggageHeatingUnattained);
			//mesure non stable
			verifierDefaut(0x03, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgRegulControlHeatingTemperatureUnstable);
			break;
		//PRG_DEFAUT_EAU
		case 4:
			//Defaut d'eau
			verifierDefaut(0x01, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgWaterDefaultLackOfWater);
			//Defaut de mesure
			verifierDefaut(0x03, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgWaterDefaultDefaultMeasure);

			break;
		//PRG_REGLAGE_OPTIQUE
		case 5:
			//Defaut réglage optique
			verifierDefaut(0x03, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgDefaultOpticalSetting);
			//Defaut 
			verifierDefaut(0x05, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgDefaultIncorrectOpticalSetting);
			//Defaut courant projecteur
			verifierDefaut(0x07, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgDefaultCurrentProjector);
			break;
		//PRG_MESURE_OPTIQUE
		case 6:
			//Defaut de mesure 
			verifierDefaut(0x03, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgOpticalMeasureDefaultMeasure);
			
			//Defaut de stabilité de la mesure
			verifierDefaut(0x05, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgOpticalMeasureDefaultStability);

			break;
		//PRG_CALCUL_ABSORBANCE
		case 7:
			//Division par zero
			verifierDefaut(0x01, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgAbsorbanceCalculDivByZero);
			break;
		//PRG_CALCUL_CONCENTRATION
		case 8:
			//Division par zero
			verifierDefaut(0x03, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgConcentrationCalculDivByZero);

			//concentration hors bornes
			verifierDefaut(0x05, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgConcentrationCalculOutOfBound);
			break;
		//PRG_CALCUL_COEF_CALIBRAGE
		case 9:
			//Division par zero
			verifierDefaut(0x05, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgCalibrationCoefCalculDivByZero);

			//Coef d'etalonnage hors écart
			verifierDefaut(0x03, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgCalibrationCoefCalculOutOfBound);
			break;
		//PRG_MULTIPLICATION
		case 10:
			//Aucun retour
		...
		case 12:
			//Division par zero
			verifierDefaut(0x03, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgLinearisationDivByZero);

			//valeur hors plage
			verifierDefaut(0x05, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgLinearisationOutOfRange);
			break;
		//PRG_LINEARISATION_INVERSE
		case 13:
			//Division par zero
			verifierDefaut(0x03, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgInverseLinDivByZero);

			//valeur hors plage
			verifierDefaut(0x05, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgInverseLinOutOfRange);
			break;
		//PRG_INIT_CONFIG
		case 14:
			//Gain inférieur ou égal à zero
			verifierDefaut(0x03, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgConfigInitNegativeGain);

			//Gain de la sonde de cuve inférieur ou égal à zero
			verifierDefaut(0x05, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgConfigInitNegativeProbeGain);
			break;
		//PRG_CALCUL_COEF_CALIBRAGE_M2
		case 15:
			//Division par zero
			verifierDefaut(0x05, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgCalibrationCoefCalculM2DivByZero);

			//Coef d'etalonnage hors écart
			verifierDefaut(0x03, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgCalibrationCoefCalculM2OutOfGap);
			break;
		//PRG_CALCUL_OFFSET_ZERO
		case 16:
			//Division par zero
			verifierDefaut(0x05, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgOffsetZeroCalculDivByZero);

			//Zéro hors bornes
			verifierDefaut(0x03, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgOffsetZeroCalculOutOfBound);
			break;
		//PRG_TITRIMETRIE
		case 17:
		case 993:
			//Temps trouvé hors écart
			verifierDefaut(0x03, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg173);
			break;
		//PRG_CONTROL_EAU_CHAUDE
		case 18:
			//eau pas à température
			verifierDefaut(0x01, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrgHeatWaterControlDefaultHeatWater);
			break;
		...
		case 20:
			...
			verifierDefaut(0x03, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg203);
			//Réglage incorrect
			verifierDefaut(0x05, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg205);
			
			break;
		case 21:
			//Mesure sonde <0
			verifierDefaut(0x03, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg213);
			//Defaut de mesure instable
			verifierDefaut(0x05, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg215);
			//Offset Entrant=0
			verifierDefaut(0x09, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg219);
			
			break;
		case 22:
			// calcul pente (Calibrage) sonde hors borne
			verifierDefaut(0x05, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg225);
			//Defaut de calcul div / zéro
			verifierDefaut(0x03, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg223);
			//Delta incorect
			verifierDefaut(0x09, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg229);
			//Delta incorect + pente mesuré incorrect
			verifierDefaut(0x0D, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg22D);
			break;
		case 23:
			// Calcul concentration après ajout sonde div /zéro
			verifierDefaut(0x03, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg233);
			//Concentration ech+ajout < ajout
			verifierDefaut(0x05, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg235);
			
			break;
		case 24:
			// coef hors borne
			verifierDefaut(0x03, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg243);
			//division par 0
			verifierDefaut(0x05, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg245);
			
			break;
		case 25:
			// division par 0 (delta1 =0)
			verifierDefaut(0x03, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg253);
			//division par 0 (?)
			verifierDefaut(0x05, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg255);
			//Calcul concentration impossible
			verifierDefaut(0x09, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg259);
			
			break;
		case 39:
			// concentration mode opératoire ou volume cuve = 0
			verifierDefaut(0x03, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg393);
			break;
		case 40:
			// Coef dénominateur formule AGV = 0
			verifierDefaut(0x03, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg403);
			// Conc AGV = 0
			verifierDefaut(0x05, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg405);
			
			break;
		case 41:
			// Division par zéro -  volume cuve = 0
			verifierDefaut(0x03, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg413);
			break;
		case 44:
			// div par 0 (delta1=0)
			verifierDefaut(0x03, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg443);	
			break;
		case 45:
			// div par 0 (Cetalon|V0|V1|V2=0)
			verifierDefaut(0x03, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg453);	
			break;
		case 46:
			// fonctionnement mode dégradé
			verifierDefaut(0x03, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg463);	
			// prévoir maintenance
			verifierDefaut(0x05, argObjVoie, argiNumMesure, argiNumPas, szMessage, &l, eErrorPrg465);	
			break;
...
void verifierDefaut(BYTE argcErrorToCheck, CStream* argObjVoie, int argiNumMesure, int argiNumPas, WCHAR* argpszMessage, int* argpIndexMessage, int argeError)
{
				...
				== argObjVoie->pGetAt(argiNumMesure)->m_StatusFailure.ucGetVal())
	{
		*argpIndexMessage  += _stprintf( argpszMessage + *argpIndexMessage
		...
		TRACE_DEBUG_IHM(eError,eMesure,argeError);
	}
}
